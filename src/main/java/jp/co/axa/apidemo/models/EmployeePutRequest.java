...
@JsonTypeName("employeePutRequest")
...
public class EmployeePutRequest {
  ...
  public EmployeePutRequest id(Employee id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EmployeePutRequest employeePutRequest = (EmployeePutRequest) o;
    return Objects.equals(this.id, employeePutRequest.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeePutRequest {\n");
