...
@JsonTypeName("employeeGetResponse")
...
public class EmployeeGetResponse {
  ...
  public EmployeeGetResponse id(Employee id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EmployeeGetResponse employeeGetResponse = (EmployeeGetResponse) o;
    return Objects.equals(this.id, employeeGetResponse.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeGetResponse {\n");
